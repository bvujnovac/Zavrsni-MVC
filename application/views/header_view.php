...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/date_format.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/chart_data.js"></script>
